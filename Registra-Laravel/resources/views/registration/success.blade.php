...
@section('title', __('messages.registration_successful'))

@section('content')
    <div class="dark-theme awesome-success-bg">
        ...
        <div class="success-wrapper awesome-success">
            ...
            <h2>{{ __('messages.registration_successful') }}</h2>
            <p>{{ __('messages.thank_you_for_registering') }}</p>

            <div class="success-actions">
                <a href="{{ route('home') }}" class="button-awesome-link">
                    <span>{{ __('messages.return_to_home') }}</span>
