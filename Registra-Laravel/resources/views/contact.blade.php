...
@section('content')
    ...
    <main class="contact-container">
        ...
        <section class="contact-info">
            ...
            <p>{{ __('messages.questions_reach_out') }}</p>

            <div class="contact-details">
                <p><i class="fas fa-map-marker-alt"></i> {{ __('messages.contact_address') }}</p>
                <p><i class="fas fa-phone"></i> {{ __('messages.contact_phone') }}</p>
                <p><i class="fas fa-envelope"></i> {{ __('messages.contact_email') }}</p>
            </div>
        </section>
        ...
        <section class="contact-form">
            ...
            <form action="{{ route('contact.submit') }}" method="post">
                ...
                <div class="form-group">
                    <textarea name="message" placeholder="{{ __('messages.your_message') }}" required></textarea>
                    @error('message')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
